...
const RecentProjects = () => {
  return (
    <div className='mt-20 py-20' id='projects'>
                ...
                <div className='flex items-center'>
                  {iconLists.map((icon, index) => (
                    <div
                      ...
                      className='mr-2 flex h-8 w-8 items-center justify-center rounded-full border border-white/[0.2] bg-black lg:h-10 lg:w-10'
                    >
